...
export function PhysiotherapyClinicalStep2({ spacesData, equipmentData, assessmentType, onComplete, inspectionReport, isReadOnly}: Step2Props) {
  // 1. CONCEPTS AND APPROACHES GRID (FIRST SECTION SEEN ON THE NEW PAGE 1)
  const [conceptsGrid, setConceptsGrid] = useState([
    { sn: 1, specialty: "Neurology", concepts: "", approaches: "", remarks: "" },
    { sn: 2, specialty: "Paediatrics", concepts: "", approaches: "", remarks: "" },
    { sn: 3, specialty: "Orthopaedics", concepts: "", approaches: "", remarks: "" },
    { sn: 4, specialty: "Cardiopulmonary", concepts: "", approaches: "", remarks: "" },
    { sn: 5, specialty: "Pelvic and Women’s Health", concepts: "", approaches: "", remarks: "" },
    { sn: 6, specialty: "Geriatrics", concepts: "", approaches: "", remarks: "" },
    { sn: 7, specialty: "Palliative care", concepts: "", approaches: "", remarks: "" },
    { sn: 8, specialty: "Community", concepts: "", approaches: "", remarks: "" },
    { sn: 9, specialty: "Mental Health", concepts: "", approaches: "", remarks: "" },
    { sn: 10, specialty: "Ergonomics/Occupational Health", concepts: "", approaches: "", remarks: "" },
    { sn: 11, specialty: "Sports and recreational", concepts: "", approaches: "", remarks: "" }
  ]);
