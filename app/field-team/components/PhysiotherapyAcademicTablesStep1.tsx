...
export function PhysiotherapyAcademicTablesStep1({ spacesData, clinicalData, equipmentData, assessmentType, onComplete, inspectionReport, isReadOnly}: Step1Props) {
