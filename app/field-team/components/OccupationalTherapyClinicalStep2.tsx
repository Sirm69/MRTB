...
export function OccupationalTherapyClinicalStep2({ spacesData, equipmentData, assessmentType, onComplete, inspectionReport, isReadOnly}: Step2Props) {
  // 1. CONCEPTS AND APPROACHES GRID (FIRST SECTION SEEN ON THE NEW PAGE 1)
  const [conceptsGrid, setConceptsGrid] = useState([
    { sn: 1, specialty: "Neurology/Neurosurgery", concepts: "", approaches: "", remarks: "" },
    { sn: 2, specialty: "Paediatrics", concepts: "", approaches: "", remarks: "" },
    { sn: 3, specialty: "Orthopaedic/Rheumatology", concepts: "", approaches: "", remarks: "" },
    { sn: 4, specialty: "Mental Health", concepts: "", approaches: "", remarks: "" },
    { sn: 5, specialty: "Geriatrics", concepts: "", approaches: "", remarks: "" },
    { sn: 6, specialty: "Community Rehabilitation", concepts: "", approaches: "", remarks: "" },
    { sn: 7, specialty: "Assistive Technology/Splinting", concepts: "", approaches: "", remarks: "" },
    { sn: 8, specialty: "Vocational Rehabilitation", concepts: "", approaches: "", remarks: "" },
    { sn: 9, specialty: "Palliative Care", concepts: "", approaches: "", remarks: "" }
  ]);
