...
export function ProstheticsOrthoticsAcademicFormStep2({ visitationDate, fieldTeamMembers, institutionName, onComplete, inspectionReport, isReviewMode, isReadOnly, onBack}: Step2Props) {
    ...
    <form onSubmit={handleFormSubmission} className="space-y-6 w-full max-w-5xl mx-auto text-xs text-gray-800 antialiased font-medium pb-24">
      ...
      <div className="bg-white p-5 rounded-xl border border-gray-300 shadow-sm space-y-4">
        ...
        <div className="border-t border-gray-100 pt-3 space-y-3">
          <span className="font-bold text-gray-900 block text-xs">Prosthetics and Orthotics Department Ecosystem</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-2 pt-2 text-gray-700 font-bold">
            {[
              { label: "Number of Prosthetics and Orthotics Lecturers", ok: "deptTherapistsAdequate", bad: "deptTherapistsInadequate" },
