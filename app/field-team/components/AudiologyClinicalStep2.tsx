...
export function AudiologyClinicalStep2({ spacesData, equipmentData, assessmentType, onComplete, inspectionReport, isReadOnly}: Step2Props) {
  // 1. CONCEPTS AND APPROACHES GRID (FIRST SECTION SEEN ON THE NEW PAGE 1)
  const [conceptsGrid, setConceptsGrid] = useState([
    { sn: 1, specialty: "Clinical Audiology", concepts: "", approaches: "", remarks: "" },
    { sn: 2, specialty: "Paediatric Audiology", concepts: "", approaches: "", remarks: "" },
    { sn: 3, specialty: "Geriatric Audiology", concepts: "", approaches: "", remarks: "" },
    { sn: 4, specialty: "Rehabilitation Audiology", concepts: "", approaches: "", remarks: "" },
    { sn: 5, specialty: "Educational Audiology", concepts: "", approaches: "", remarks: "" },
    { sn: 6, specialty: "Vestibular Audiology", concepts: "", approaches: "", remarks: "" },
    { sn: 7, specialty: "Cochlear implant and implantable Devices", concepts: "", approaches: "", remarks: "" },
    { sn: 8, specialty: "Occupational Audiology", concepts: "", approaches: "", remarks: "" },
    { sn: 9, specialty: "Tinnitus and Hyperacusis Management", concepts: "", approaches: "", remarks: "" },
    { sn: 10, specialty: "Public Health, Research and Academic Audiology", concepts: "", approaches: "", remarks: "" }
  ]);
