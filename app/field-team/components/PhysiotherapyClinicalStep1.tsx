...
export function PhysiotherapyClinicalStep1({ visitationDate, fieldTeamMembers, onComplete, inspectionReport, isReviewMode, isReadOnly, onBack}: Step1Props) {
  ...
  const [clinicalStaff, setClinicalStaff] = useState({
    ...
    chiefPhysiotherapists: "", principalPhysiotherapists: "",
    seniorPhysiotherapists: "", physiotherapists: "",
    internPhysiotherapists: "", locumPhysiotherapist: "", nyscPhysiotherapist: "",
    totalPhysiotherapist: "", comments: "", recommendations: ""
  });
  ...
  const [spaceEval, setSpaceForm] = useState({
    ...
    // Physio Specific spaces
    adultGymSize: "", adultGymFloorStructure: "", adultGymAccessibility: "", adultGymDisability: "", adultGymEquipment: "", adultGymScreens: "", adultGymVentilation: "", adultGymIllumination: "", adultGymComments: "", adultGymRecs: "",
    paediatricGymSize: "", paediatricGymFloorStructure: "", paediatricGymAccessibility: "", paediatricGymDisability: "", paediatricGymEquipment: "", paediatricGymScreens: "", paediatricGymVentilation: "", paediatricGymIllumination: "", paediatricGymComments: "", paediatricGymRecs: "",
    hydroPoolAvailable: "", hydroPoolSize: "", hydroPoolLifeJackets: "", hydroPoolEquipment: "", hydroPoolMaintenance: "", hydroPoolComments: "", hydroPoolRecs: "",
    ...
    otherOfficesPrincipal: "", otherOfficesSenior: "", otherOfficesPhysiotherapist: "", otherOfficesInterns: "", 
  ...
  const [equipEval, setEquipEval] = useState({
    gymnasium: "", electrotherapy: "", diagnostics: "", infectiousControl: "", safetyMeasures: "", consumables: "",
    neurology: "", paediatrics: "", orthopaedics: "", cardiopulmonary: "", pelvicWomensHealth: "", geriatric: "", palliativeCare: "", community: "", mentalHealth: "", ergonomicsOccupational: "", sportsRecreational: "",
    ...
    <form onSubmit={handleFormSubmission} className="space-y-6 w-full max-w-5xl mx-auto text-xs text-gray-800 antialiased font-medium pb-12">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-1.5 pt-1">
            {[
              ...
              { label: "Total number of Chief Physiotherapists", f: "chiefPhysiotherapists" },
              { label: "Total number of Senior Physiotherapists", f: "seniorPhysiotherapists" },
              { label: "Total number of Physiotherapists", f: "audiologists" },
              { label: "Total number of Intern Physiotherapists", f: "internPhysiotherapists" },
              { label: "Total number of Locum Physiotherapist", f: "locumPhysiotherapist" },
              { label: "Total number of NYSC Physiotherapist", f: "nyscPhysiotherapist" },
              { label: "Total number of Physiotherapists", f: "totalPhysiotherapist" }
            ].map(item => (
      ...
      <div className="bg-white p-5 rounded-xl border border-gray-300 shadow-sm space-y-4">
        ...
        <div className="space-y-4 divide-y divide-gray-100">
          ...
          {/* Adult Gymnasium */}
          <div className="pt-3 space-y-2">
            <span className="font-bold text-gray-700 block">Adult Gymnasium:</span>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 font-semibold text-gray-700">
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Size:</span><div className="flex gap-2"><label><input type="radio" name="agSz" checked={spaceEval.adultGymSize === 'Small'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymSize', 'Small')} /> Small</label><label><input type="radio" name="agSz" checked={spaceEval.adultGymSize === 'Large'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymSize', 'Large')} /> Large</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Layout:</span><div className="flex gap-2"><label><input type="radio" name="agCond" checked={spaceEval.adultGymSize === 'Crowded'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymSize', 'Crowded')} /> Crowded</label><label><input type="radio" name="agCond" checked={spaceEval.adultGymSize === 'Spacious'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymSize', 'Spacious')} /> Spacious</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Floor:</span><select value={spaceEval.adultGymFloorStructure} onChange={(e) => handleFieldUpdate(setSpaceForm, 'adultGymFloorStructure', e.target.value)} className="p-1 border border-gray-300 rounded bg-white text-xs outline-none"><option value="">Select</option><option value="Wooden">Wooden</option><option value="Tiled">Tiled</option><option value="Rugged">Rugged</option><option value="Concrete">Concrete</option><option value="Synthetic">Synthetic</option></select></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Accessibility:</span><div className="flex gap-1.5"><label><input type="radio" name="agAcc" checked={spaceEval.adultGymAccessibility === 'Large'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymAccessibility', 'Large')} /> Large</label><label><input type="radio" name="agAcc" checked={spaceEval.adultGymAccessibility === 'Small'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymAccessibility', 'Small')} /> Small</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Disability Compliant:</span><div className="flex gap-2"><label><input type="radio" name="agDc" checked={spaceEval.adultGymDisability === 'Yes'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymDisability', 'Yes')} /> Yes</label><label><input type="radio" name="agDc" checked={spaceEval.adultGymDisability === 'No'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymDisability', 'No')} /> No</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Equipment:</span><div className="flex gap-2"><label><input type="radio" name="agEq" checked={spaceEval.adultGymEquipment === 'Adequate'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymEquipment', 'Adequate')} /> Adeq</label><label><input type="radio" name="agEq" checked={spaceEval.adultGymEquipment === 'Inadequate'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymEquipment', 'Inadequate')} /> Inadeq</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Screens:</span><div className="flex gap-2"><label><input type="radio" name="agSc" checked={spaceEval.adultGymScreens === 'Adequate'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymScreens', 'Adequate')} /> Adeq</label><label><input type="radio" name="agSc" checked={spaceEval.adultGymScreens === 'Inadequate'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymScreens', 'Inadequate')} /> Inadeq</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Ventilation:</span><div className="flex gap-1.5"><label><input type="radio" name="agVent" checked={spaceEval.adultGymVentilation === 'Good'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymVentilation', 'Good')} /> G</label><label><input type="radio" name="agVent" checked={spaceEval.adultGymVentilation === 'Fair'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymVentilation', 'Fair')} /> F</label><label><input type="radio" name="agVent" checked={spaceEval.adultGymVentilation === 'Poor'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymVentilation', 'Poor')} /> P</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Illumination:</span><div className="flex gap-1.5"><label><input type="radio" name="agIllum" checked={spaceEval.adultGymIllumination === 'Good'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymIllumination', 'Good')} /> G</label><label><input type="radio" name="agIllum" checked={spaceEval.adultGymIllumination === 'Fair'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymIllumination', 'Fair')} /> F</label><label><input type="radio" name="agIllum" checked={spaceEval.adultGymIllumination === 'Poor'} onChange={() => handleFieldUpdate(setSpaceForm, 'adultGymIllumination', 'Poor')} /> P</label></div></div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2"><textarea placeholder="Adult Gym Comments" value={spaceEval.adultGymComments} onChange={(e) => handleFieldUpdate(setSpaceForm, 'adultGymComments', e.target.value)} className="p-1.5 border border-gray-300 rounded h-12 resize-none outline-none" /><textarea placeholder="Adult Gym Recommendations" value={spaceEval.adultGymRecs} onChange={(e) => handleFieldUpdate(setSpaceForm, 'adultGymRecs', e.target.value)} className="p-1.5 border border-gray-300 rounded h-12 resize-none outline-none" /></div>
          </div>

          {/* Paediatric Gymnasium */}
          <div className="pt-3 space-y-2">
            <span className="font-bold text-gray-700 block">Paediatric Gymnasium:</span>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 font-semibold text-gray-700">
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Size:</span><div className="flex gap-2"><label><input type="radio" name="pgSz" checked={spaceEval.paediatricGymSize === 'Small'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymSize', 'Small')} /> Small</label><label><input type="radio" name="pgSz" checked={spaceEval.paediatricGymSize === 'Large'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymSize', 'Large')} /> Large</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Layout:</span><div className="flex gap-2"><label><input type="radio" name="pgCond" checked={spaceEval.paediatricGymSize === 'Crowded'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymSize', 'Crowded')} /> Crowded</label><label><input type="radio" name="pgCond" checked={spaceEval.paediatricGymSize === 'Spacious'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymSize', 'Spacious')} /> Spacious</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Floor:</span><select value={spaceEval.paediatricGymFloorStructure} onChange={(e) => handleFieldUpdate(setSpaceForm, 'paediatricGymFloorStructure', e.target.value)} className="p-1 border border-gray-300 rounded bg-white text-xs outline-none"><option value="">Select</option><option value="Wooden">Wooden</option><option value="Tiled">Tiled</option><option value="Rugged">Rugged</option><option value="Concrete">Concrete</option><option value="Synthetic">Synthetic</option></select></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Accessibility:</span><div className="flex gap-1.5"><label><input type="radio" name="pgAcc" checked={spaceEval.paediatricGymAccessibility === 'Large'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymAccessibility', 'Large')} /> Large</label><label><input type="radio" name="pgAcc" checked={spaceEval.paediatricGymAccessibility === 'Small'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymAccessibility', 'Small')} /> Small</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Disability Compliant:</span><div className="flex gap-2"><label><input type="radio" name="pgDc" checked={spaceEval.paediatricGymDisability === 'Yes'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymDisability', 'Yes')} /> Yes</label><label><input type="radio" name="pgDc" checked={spaceEval.paediatricGymDisability === 'No'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymDisability', 'No')} /> No</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Equipment:</span><div className="flex gap-2"><label><input type="radio" name="pgEq" checked={spaceEval.paediatricGymEquipment === 'Adequate'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymEquipment', 'Adequate')} /> Adeq</label><label><input type="radio" name="pgEq" checked={spaceEval.paediatricGymEquipment === 'Inadequate'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymEquipment', 'Inadequate')} /> Inadeq</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Screens:</span><div className="flex gap-2"><label><input type="radio" name="pgSc" checked={spaceEval.paediatricGymScreens === 'Adequate'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymScreens', 'Adequate')} /> Adeq</label><label><input type="radio" name="pgSc" checked={spaceEval.paediatricGymScreens === 'Inadequate'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymScreens', 'Inadequate')} /> Inadeq</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Ventilation:</span><div className="flex gap-1.5"><label><input type="radio" name="pgVent" checked={spaceEval.paediatricGymVentilation === 'Good'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymVentilation', 'Good')} /> G</label><label><input type="radio" name="pgVent" checked={spaceEval.paediatricGymVentilation === 'Fair'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymVentilation', 'Fair')} /> F</label><label><input type="radio" name="pgVent" checked={spaceEval.paediatricGymVentilation === 'Poor'} onChange={() => handleFieldUpdate(setSpaceForm, 'paediatricGymVentilation', 'Poor')} /> P</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Illumination:</span><div className="flex gap-1.5"><label><input type="radio" name="pgIllum" checked={spaceEval.paediatricGymIllumination === 'Good'} onChange={() => handleFieldUpdate(setSpaceForm, 'pgIllum', 'Good')} /> G</label><label><input type="radio" name="pgIllum" checked={spaceEval.paediatricGymIllumination === 'Fair'} onChange={() => handleFieldUpdate(setSpaceForm, 'pgIllum', 'Fair')} /> F</label><label><input type="radio" name="pgIllum" checked={spaceEval.paediatricGymIllumination === 'Poor'} onChange={() => handleFieldUpdate(setSpaceForm, 'pgIllum', 'Poor')} /> P</label></div></div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2"><textarea placeholder="Paediatric Gym Comments" value={spaceEval.paediatricGymComments} onChange={(e) => handleFieldUpdate(setSpaceForm, 'paediatricGymComments', e.target.value)} className="p-1.5 border border-gray-300 rounded h-12 resize-none outline-none" /><textarea placeholder="Paediatric Gym Recommendations" value={spaceEval.paediatricGymRecs} onChange={(e) => handleFieldUpdate(setSpaceForm, 'paediatricGymRecs', e.target.value)} className="p-1.5 border border-gray-300 rounded h-12 resize-none outline-none" /></div>
          </div>

          {/* Hydrotherapy Unit */}
          <div className="pt-3 space-y-2">
            <span className="font-bold text-gray-700 block">Hydrotherapy Unit:</span>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 font-semibold text-gray-700">
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Pool Status:</span><div className="flex gap-2"><label><input type="radio" name="hpAv" checked={spaceEval.hydroPoolAvailable === 'Available'} onChange={() => handleFieldUpdate(setSpaceForm, 'hydroPoolAvailable', 'Available')} /> Avail</label><label><input type="radio" name="hpAv" checked={spaceEval.hydroPoolAvailable === 'Not Available'} onChange={() => handleFieldUpdate(setSpaceForm, 'hydroPoolAvailable', 'Not Available')} /> N/A</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Pool Size:</span><div className="flex gap-2"><label><input type="radio" name="hpSz" checked={spaceEval.hydroPoolSize === 'Small'} onChange={() => handleFieldUpdate(setSpaceForm, 'hydroPoolSize', 'Small')} /> Small</label><label><input type="radio" name="hpSz" checked={spaceEval.hydroPoolSize === 'Medium'} onChange={() => handleFieldUpdate(setSpaceForm, 'hydroPoolSize', 'Medium')} /> Med</label><label><input type="radio" name="hpSz" checked={spaceEval.hydroPoolSize === 'Large'} onChange={() => handleFieldUpdate(setSpaceForm, 'hydroPoolSize', 'Large')} /> Large</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Life Jackets:</span><div className="flex gap-2"><label><input type="radio" name="hpLf" checked={spaceEval.hydroPoolLifeJackets === 'Available'} onChange={() => handleFieldUpdate(setSpaceForm, 'hydroPoolLifeJackets', 'Available')} /> Avail</label><label><input type="radio" name="hpLf" checked={spaceEval.hydroPoolLifeJackets === 'Not Available'} onChange={() => handleFieldUpdate(setSpaceForm, 'hydroPoolLifeJackets', 'Not Available')} /> N/A</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Equipment:</span><div className="flex gap-2"><label><input type="radio" name="hpEq" checked={spaceEval.hydroPoolEquipment === 'Adequate'} onChange={() => handleFieldUpdate(setSpaceForm, 'hydroPoolEquipment', 'Adequate')} /> Adeq</label><label><input type="radio" name="hpEq" checked={spaceEval.hydroPoolEquipment === 'Inadequate'} onChange={() => handleFieldUpdate(setSpaceForm, 'hydroPoolEquipment', 'Inadequate')} /> Inadeq</label></div></div>
              <div className="flex items-center justify-between p-1.5 bg-slate-50 rounded"><span>Maintenance:</span><div className="flex gap-1.5"><label><input type="radio" name="hpMn" checked={spaceEval.hydroPoolMaintenance === 'Good'} onChange={() => handleFieldUpdate(setSpaceForm, 'hydroPoolMaintenance', 'Good')} /> G</label><label><input type="radio" name="hpMn" checked={spaceEval.hydroPoolMaintenance === 'Fair'} onChange={() => handleFieldUpdate(setSpaceForm, 'hydroPoolMaintenance', 'Fair')} /> F</label><label><input type="radio" name="hpMn" checked={spaceEval.hydroPoolMaintenance === 'Poor'} onChange={() => handleFieldUpdate(setSpaceForm, 'hydroPoolMaintenance', 'Poor')} /> P</label></div></div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2"><textarea placeholder="Hydrotherapy Comments" value={spaceEval.hydroPoolComments} onChange={(e) => handleFieldUpdate(setSpaceForm, 'hydroPoolComments', e.target.value)} className="p-1.5 border border-gray-300 rounded h-12 resize-none outline-none" /><textarea placeholder="Hydrotherapy Recommendations" value={spaceEval.hydroPoolRecs} onChange={(e) => handleFieldUpdate(setSpaceForm, 'hydroPoolRecs', e.target.value)} className="p-1.5 border border-gray-300 rounded h-12 resize-none outline-none" /></div>
          </div>
            ...
            <div className="p-3 border border-gray-200 bg-slate-50/50 rounded-xl space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 font-semibold text-gray-700">
                {[
                  ...
                  { label: "Number of offices for Chief Physiotherapist", f: "otherOfficesChief" },
                  { label: "Number of offices for Principal Physiotherapist", f: "otherOfficesPrincipal" },
                  { label: "Number of offices for Senior Physiotherapist", f: "otherOfficesSenior" },
                  { label: "Number of offices for Physiotherapist", f: "otherOfficesPhysiotherapist" },
                  { label: "Number of offices for Interns", f: "otherOfficesInterns" },
                  { label: "Number of offices for Locum/Corp members Physiotherapist", f: "otherOfficesLocumCorp" },
      ...
      <div className="bg-white p-5 rounded-xl border border-gray-300 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 font-semibold text-gray-700">
          ...
          <div>
            <label className="font-bold text-gray-600 block mb-1">Physiotherapy (inpatient side wards)</label>
