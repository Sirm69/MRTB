...
export function ProstheticsOrthoticsClinicalStep2({ spacesData, equipmentData, assessmentType, onComplete, inspectionReport, isReadOnly}: Step2Props) {
  // 1. CONCEPTS AND APPROACHES GRID (FIRST SECTION SEEN ON THE NEW PAGE 1)
  const [conceptsGrid, setConceptsGrid] = useState([
    { sn: 1, specialty: "Prosthetics", concepts: "", approaches: "", remarks: "" },
    { sn: 2, specialty: "Orthotics", concepts: "", approaches: "", remarks: "" },
    { sn: 3, specialty: "Paediatric Prosthetics and Orthotics", concepts: "", approaches: "", remarks: "" },
    { sn: 4, specialty: "Geriatric Prosthetics and Orthotics", concepts: "", approaches: "", remarks: "" },
    { sn: 5, specialty: "Sports and Recreational Prosthetics and Orthotics", concepts: "", approaches: "", remarks: "" },
    { sn: 6, specialty: "Clinical Performance Measures", concepts: "", approaches: "", remarks: "" }
  ]);
