...
export function SpeechAcademicTablesStep1({ visitationDate, fieldTeamMembers, institutionName, spacesData, clinicalData, equipmentData, assessmentType, onComplete, inspectionReport, isReadOnly}: Step1Props) {
        ...
        <div className="border-t border-gray-100 pt-3 space-y-2.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input type="text" value={preamble.programToAccredit} onChange={(e) => handleFieldUpdate(setPreamble, 'programToAccredit', e.target.value)} className="w-full py-1.5 px-2.5 border border-gray-200 focus:border-[#5D9C0E] focus:ring-1 focus:ring-[#5D9C0E]/20 rounded-lg bg-white text-xs outline-none transition-colors" placeholder="e.g. B.Sc Speech Therapy" />
            </div>
